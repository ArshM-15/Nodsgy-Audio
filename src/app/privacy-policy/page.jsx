...
export default function PrivacyPolicy() {
  return (
    <div className="w-[80%] ml-[5rem]">
      ...
      <p className="mb-10">Last updated: November 03, 2024</p>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Nodsgy.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Nodsgy, accessible from{" "}
            <a
              href="https://www.nodsgy.com/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.nodsgy.com/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li className="font-bold mb-10">By email: creatorofnodsgy@gmail.com</li>
      </ul>
    </div>
  );
}
