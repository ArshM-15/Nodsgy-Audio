  ...
  return (
    <div className="w-[80%] ml-[5rem]">
      ...
      <p>
        ...
        conditions. Do not continue to use Nodsgy if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing Nodsgy, you agreed to use
        cookies in agreement with the Nodsgy's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Nodsgy and/or its licensors own the
        intellectual property rights for all material on Nodsgy. All
        intellectual property rights are reserved. You may access this from
        Nodsgy for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Nodsgy</li>
        <li>Sell, rent or sub-license material from Nodsgy</li>
        <li>Reproduce, duplicate or copy material from Nodsgy</li>
        <li>Redistribute content from Nodsgy</li>
      </ul>
      ...
      <p>
        ...
        Nodsgy does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Nodsgy,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Nodsgy shall not be liable for the
      ...
      <p>
        Nodsgy reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Nodsgy a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of Nodsgy; and (d) the link is in
      ...
      <p>
        ...
        e-mail to Nodsgy. Please include your name, your organization name,
      ...
      <p>
        No use of Nodsgy's logo or other artwork will be allowed for linking
